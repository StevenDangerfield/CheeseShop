...
describe('CheeseList', () => {
  it('renders', async () => {
    await act(async () => {
      render(<CheeseList cheeses={[]} onCheeseDeleted={onCheeseDeleted}/>);
    });
  ...
  it('shows a cheese item', async () => {
    ...
    await act(async () => {
      render(<CheeseList cheeses={cheddar} onCheeseDeleted={onCheeseDeleted}/>);
    });
